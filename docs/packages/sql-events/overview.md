...
The Platformatic DB sql-events uses [mqemitter](http://npm.im/mqemitter) to publish events when [entities](/packages/sql-mapper/entities/overview.md) are saved and deleted.
...
use [@platformatic/sql-mapper hooks](/packages/sql-mapper/entities/hooks.md).
