...
Take a look to at the reference documentation for [Authorization](/docs/reference/db/authorization/overview).
...
Please refer to our guide to set up [Auth0](/docs/reference/db/jwt-auth0) for more information
on JSON Web Tokens.
