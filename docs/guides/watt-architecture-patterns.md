...
a CPU worker pool that stores results through a shared I/O application.
...
Scale the CPU-bound applications first. Give them worker limits that match the CPU budget
