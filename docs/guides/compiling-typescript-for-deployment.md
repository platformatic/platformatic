...
## Avoid shipping the TypeScript sources

If you want to avoid shipping the TypeScript sources you need to configure Platformatic the location
where your files have been built, adding an `outDir` option:
