...
import { getGlobal, type PlatformaticGlobal, type PlatformaticGlobalInterface } from '../../lib/index.js'

test("getGlobal", () => {
  expect(getGlobal()).type.toBe<PlatformaticGlobal>()
  expect(getGlobal<{ extra: boolean }>()).type.toBe<PlatformaticGlobal & { extra: boolean }>()
...
test("PlatformaticGlobalInterface", () => {
  ...
  expect(global).type.toBe<PlatformaticGlobalInterface>()
