...
export declare const kRoot: unique symbol
export declare const kEnvironment: unique symbol
...
export declare function listRecognizedConfigurationFiles(suffixes?: string | string[] | null, extensions?: string | string[]): string[]
export declare function matchKnownSchema(config: any, throwOnMissing?: boolean): string | SchemaMatch | null
export declare function findConfigurationFile(root: string, suffixes?: string | string[], extensions?: string | string[], candidates?: string[]): Promise<string | null>
export declare function findConfigurationFileRecursive(root: string, configurationFile?: string, schemas?: string | string[], suffixes?: string | string[]): Promise<string | null>
...
export declare function searchFilesWithExtensions(root: string, extensions: string | string[], globOptions?: object): Promise<string[]>
export declare function searchJavascriptFiles(projectDir: string, globOptions?: object): Promise<string[]>
export declare function hasFilesWithExtensions(root: string, extensions: string | string[], globOptions?: object): Promise<boolean>
...
export declare function buildPinoOptions(loggerConfig: any, serverConfig: any, serviceId?: string, workerId?: string, context?: any, root?: string): object
...
export declare function detectApplicationType(root: string, packageJson?: any): Promise<{ name: string; label: string } | null>
