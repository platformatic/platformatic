...
test('openapi client generation (javascript)', async (t) => {
  ...
  await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), app.url, '--name', 'movies', '--type', 'openapi', '--full', 'false'])
...
test('openapi client generation (typescript)', async (t) => {
  ...
  await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), app.url + '/documentation/json', '--name', 'movies', '--full', 'false'])
...
test('no such file', async (t) => {
  ...
  await rejects(execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), `${app.url}/foo/bar`, '--name', 'movies', '--full', 'false']))
})
...
test('full-response option', async (t) => {
  ...
  await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), app.url + '/documentation/json', '--name', 'movies', '--full', 'false', '--full-response'])
...
test('openapi client generation (javascript) from file', async (t) => {
  ...
  await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), openAPIfile, '--name', 'movies', '--full', 'false'])
...
test('name with dashes', async (t) => {
  ...
  try {
    await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), app.url + '/documentation/json', '--name', 'uncanny-movies', '--full', 'false'])
  } catch (err) {
...
test('optional-headers option', async (t) => {
  ...
  await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), openAPIfile, '--name', 'movies', '--optional-headers', 'foobar,authorization', '--types-only', '--full', 'false'])
...
`), true)
  ...
  await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), openAPIfile, '--name', 'commonparams', '--full-request', '--full', 'false'])
...
test('tsdoc client description', async (t) => {
  ...
  await execa('node', [desm.join(import.meta.url, '..', 'cli.mjs'), openAPIfile, '--name', 'tsdoc', '--full', 'false'])
