...
export default myPlugin
  ...
  await execa('node', [join(import.meta.dirname, '..', 'cli.mjs'), app.url + '/documentation/json', '--name', 'movies', '--types-only', '--full', 'false'])
...
export default myPlugin
  ...
  await execa('node', [join(import.meta.dirname, '..', 'cli.mjs'), app.url + '/documentation/json', '--name', 'movies', '--folder', 'uncanny', '--types-only', '--full', 'false'])
