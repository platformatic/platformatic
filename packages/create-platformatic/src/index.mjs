...
import {
  ...
  executeWithTimeout,
  findConfigurationFile as findConfigurationFileRecursive,
  generateDashedName,
  getPkgManager,
...
export async function createApplication (
  ...
  const runtimeConfigFile = await findConfigurationFileRecursive(projectDir, null, 'runtime')
  ...
  if (runtimeConfigFile) {
    ...
    if (applicationRoot) {
      ...
      const existingRuntime = await findConfigurationFileRecursive(applicationRoot, null, 'runtime')
