...
export interface PlatformaticNextJsConfig {
  ...
  application?: BuildableApplicationOptions;
  runtime?: {
    preload?: string | string[];
    extensions?: string | ExtensionEntry | (string | ExtensionEntry1)[];
    basePath?: string;
    services?: ApplicationEntry[];
    workers?: number | string | WorkersOptions;
    workersRestartDelay?: number | string;
    logger?: AppLoggerOptions1;
    ...
    healthProbes?: boolean | string | HealthProbesOptions;
    ...
    application?: {
      reuseTcpPorts?: boolean;
      workers?: number | string | ApplicationWorkersOptions;
...
export interface BuildableApplicationOptions {
  basePath?: string;
...
export interface ExtensionEntry1 {
  path: string;
  options?: {
    [k: string]: unknown;
  };
...
export interface HttpsOptions1 {
  allowHTTP1?: boolean;
  key:
    | string
    | {
...
export interface CompileCacheOptions1 {
  /**
   * Enable Node.js module compile cache for faster startup
   */
  enabled?: boolean;
...
export interface NextHttpsOptions {
  enabled?: boolean | string;
  key?: string;
  cert?: string;
  ca?: string;
