...
export declare const FailedToGetRuntimeScheduler: (value: string) => FastifyError
export declare const FailedToUpdateRuntimeScheduler: (value: string) => FastifyError
