...
expectType<number | string | undefined>(metric.values[0].labels?.status_code)
...
expectType<string | undefined>(metric.values[0].labels?.server_address)
expectType<number | string | undefined>(metric.values[0].labels?.server_port)
expectType<string | undefined>(metric.values[0].labels?.url_scheme)
expectType<string | undefined>(metric.values[0].labels?.error_type)
