...
test('should start a REPL session for a subprocess application (useHttp: true)', async t => {
  ...
  ok(output.includes('>'), 'REPL should send a prompt for subprocess')
  ...
  ok(output.includes('2'), 'REPL should evaluate expressions and return results for subprocess')
...
test('subprocess REPL should have access to platformatic globals', async t => {
  ...
  ok(output.includes("'object'"), 'platformatic should be available in subprocess REPL context')
  ...
  ok(output.includes("'object'"), 'config should be available in subprocess REPL context')
...
test('subprocess REPL should handle .exit command', async t => {
  ...
  ok(exitReceived, 'subprocess REPL should send exit message when .exit is entered')
})
