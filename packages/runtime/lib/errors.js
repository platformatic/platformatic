...
module.exports = {
  ...
  FailedToRetrieveCustomHealthcheckError: createError(`${ERROR_PREFIX}_FAILED_TO_RETRIEVE_CUSTOM_HEALTHCHECK`, 'Failed to retrieve custom healthcheck for service with id "%s": %s'),
