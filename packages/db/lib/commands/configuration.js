...
/*
  ...
  A command is handed the application's already-resolved configuration as data -- the loader
  ...
  It used to take a path and load it. Now the entry carries no path -- `prepareRuntimeApplication`
