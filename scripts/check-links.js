...
import { access, constants, existsSync, readFileSync } from 'node:fs'
        ...
        while ((match = pattern.exec(line)) !== null) {
          ...
          if (!url.startsWith('http://') && !url.startsWith('https://')) {
            ...
            if (url.startsWith('./') || url.startsWith('../') || !url.includes('://')) {
              ...
              const absolutePath = _resolve(dirname(readmePath), url)
...
export default { findReadmeFiles, extractLinks, checkHttpLink, checkFileLink, checkAllLinks }
